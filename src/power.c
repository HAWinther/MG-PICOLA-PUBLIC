...
//==========================================================================================================//
// v1.0: This file contains the routines for setting up the initial power spectrum of the simulation.       //
// v2.0: This file now also contains routines for setting up the initial transfer function of the simulation//
//      as well as some other updates and run-time checks on the power spectrum/transfer function.          //
...
void initialize_transferfunction(void) {
   ...
   DstartFnl = growth_D(FnlTime);
#endif

   if(WhichTransfer == 1 && !ReadParticlesFromFile ) read_transfer_table();
}
...
//====================================================================
// Calculate the transfer function at k for a tabulated power spectrum
//====================================================================
...
double PowerSpec_Tabulated(double k) {
  int binlow, binhigh, binmid;
  double logk, logP, P, u, dlogk, Delta2;
